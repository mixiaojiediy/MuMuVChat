...
import com.mumuavchat.ise.result.xml.XmlResultParser;
import com.mumuavchat.speech.setting.IseSettings;
...
public class IseDemo extends Activity implements OnClickListener {
    ...
    public void onClick(View view) {
        ...
        } else if (id == R.id.ise_parse) {// 解析最终结果
