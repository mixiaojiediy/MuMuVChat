...
import com.mumuavchat.speech.setting.TtsSettings;
import com.mumuavchat.voicedemo.faceonline.OnlineFaceDemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        findViewById(R.id.vChatBtn).setOnClickListener(v -> {
            isPrivacyConfirm(new Intent(MainActivity.this, MuMuAVChat.class));
        });
        // test
